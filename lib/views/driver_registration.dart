...
class _DriverRegisterScreenState extends State<DriverRegisterScreen> {
  ...
  late final DriverRegisterBackend _backend;
  final AuthController controller = Get.find<AuthController>();

  @override
  void initState() {
    super.initState();
    _backend = DriverRegisterBackend(context: context);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text("Create a Driver Account",
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    buildLabeledTextField("Bus Number", controller.busNumberController),
                    const SizedBox(height: 20),
                    buildLabeledTextField("Bus Name", controller.busNameController),
                    const SizedBox(height: 20),
                    const Text("Route"),
                    DropdownButtonFormField<String>(
                      value: selectedRoute,
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            final result = await _backend.handleRegister(
                              ...
                              busNumber: controller.busNumberController.text.trim(),
                              busName: controller.busNameController.text.trim(),
                              route: selectedRoute,
                            );
                            if (result.success) {
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                title: Center(
                  child: Text(
                    "Your driver account is all set up.",
